...
import org.firstinspires.ftc.teamcode.opmodes.auto.commands.AutoComGyroTurnHalfGlyph;
...
public class AutoRedFront3 extends RelicOpModes {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch(pictograph){
            case LEFT:
                //new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.LEFT, 0.6, 5.5).Run();
                break;
            case CENTER:
                new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.LEFT, 0.6, 7.5).Run();
                break;
            case RIGHT:
                //new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.LEFT, 0.6, 8.0).Run();
                break;
            default:
                //new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.LEFT, 0.6, 8.0).Run();
                break;
        ...
        telemetry.update();
        if(leftDistance < 17.0){
            new AutoComMecDrive(this, DriveMecanum.DriveDirection.RIGHT, 1.0, 12.0).Run();
        } else if(leftDistance < 47.0){
            new AutoComMecDrive(this, DriveMecanum.DriveDirection.RIGHT, 1.0, 47.0 - leftDistance).Run();
        }
