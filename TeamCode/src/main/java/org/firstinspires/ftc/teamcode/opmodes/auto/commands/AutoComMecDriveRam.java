...
public class AutoComMecDriveRam extends AutoCommandMain {
    ...
    public AutoComMecDriveRam(RelicOpModes opMode, DriveMecanum.DriveDirection direction, double speed, double distance){
        super(opMode);
