...
public class AutoBlueFront1Fast extends RelicOpModes {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch(pictograph){
            case RIGHT:
                new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.BACKWARD, 0.5, 34.0).Run();
                bot.glyphPlatform.gripClose();
                ...
                break;
            case CENTER:
                new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.BACKWARD, 0.5, 26.5).Run();
                bot.glyphPlatform.gripClose();
                bot.glyphPlatform.up();
            ...
            case LEFT:
                ...
                new AutoComMecDrive(this, DriveMecanum.DriveDirection.BACKWARDLEFT, 0.6, 10.0).Run();
                bot.glyphPlatform.gripRelease();
                wait(0.5);
