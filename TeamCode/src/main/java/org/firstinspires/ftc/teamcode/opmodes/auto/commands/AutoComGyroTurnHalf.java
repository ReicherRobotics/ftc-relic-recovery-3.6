...
public class AutoComGyroTurnHalf extends AutoCommandMain {
    private double maxSpeed = 0.0;
    private DriveMecanum.DriveDirection direction = DriveMecanum.DriveDirection.FORWARD;
    private double targetHeading = 0.0;
    private double tolerance = 2.5;

    public AutoComGyroTurnHalf(RelicOpModes opMode, DriveMecanum.DriveDirection direction, double speed, double angle){
        super(opMode);
