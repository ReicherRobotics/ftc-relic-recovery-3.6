...
public class AutoComMecDiagDrive extends AutoCommandMain {
    ...
    public AutoComMecDiagDrive(RelicOpModes opMode, DriveMecanum.DriveDirection direction, double speed, double distance){
        super(opMode);
