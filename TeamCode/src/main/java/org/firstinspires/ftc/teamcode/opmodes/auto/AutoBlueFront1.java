...
@Autonomous(name="Blue Front 1", group="Main 1")
@Disabled
public class AutoBlueFront1 extends RelicOpModes {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch(pictograph){
            case RIGHT:
                new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.BACKWARD, 0.3, 39.5).Run();
                break;
            case CENTER:
                new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.BACKWARD, 0.3, 32.0).Run();
                break;
            case LEFT:
                new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.BACKWARD, 0.3, 24.5).Run();
                break;
            default:
                new AutoComMecDriveRam(this, DriveMecanum.DriveDirection.BACKWARD, 0.3, 24.5).Run();
                break;
        }
        new AutoComGyroTurn(this,0.5, 120.0).Run();
        bot.glyphPlatform.gripClose();
        bot.glyphPlatform.up();
        new AutoComMecDrive(this, DriveMecanum.DriveDirection.LEFT, 0.3, 14.0).Run();
        bot.glyphPlatform.gripRelease();
        wait(0.5);
